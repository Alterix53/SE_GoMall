...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="product-card">
      ...
      {/* Rank Badge */}
      {product.rank && product.rank <= 3 && <div className={`rank-badge rank-${product.rank}`}>#{product.rank}</div>}
      ...
      <div className="product-link">
        ...
        <div className="product-info">
          ...
          <div className="price-section">
            ...
            {product.originalPrice && <div className="original-price">{formatPrice(product.originalPrice)}</div>}
          </div>
